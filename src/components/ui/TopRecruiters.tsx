  ...
  return (
    <Card className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Badge className="bg-blue-100 text-blue-800">120+ Companies</Badge>
      </div>

      <div className="mb-6 relative w-full h-24">
        <Image
      ...
      <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            ...
            <div className="text-sm text-gray-600">New Recruiters</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-blue-600">68%</div>
            <div className="text-sm text-gray-600">Tech Sector</div>
          </div>
          <div>
